...
angular.module('myApp.controllers', []).
 ...
 controller('TreeController', ['$scope', 'Restangular', function($scope, Restangular) {
		Restangular.one("decisiontree").get().then(function(response) {
			var g = graphlibDot.parse(response.tree);
			console.log(g);
			var renderer = new dagreD3.Renderer();
			  ...
			  //TODO: Implement navigable tree - http://bl.ocks.org/pprett/raw/3813537/ Refer iris.json format demo - http://bl.ocks.org/pprett/raw/3813537/
			  //Refer https://github.com/cpettitt/graphlib-dot/blob/master/dist/graphlib-dot.js for dot parsing logic.
			  //Curr output format of graphlib dot is dagre input format. Need d3 input format like iris.json. Notice diff from below format.
			  //Target - Convert from Dagre format to D3 tree layout format.
			  //https://github.com/cpettitt/dagre
			  //https://github.com/cpettitt/dagre-d3
			  //Use https://github.com/d3/d3-collection#nests to convert
//			$scope.tree = {
//					 "name": "flare",
//					 "children": [
//					  {
...
//		 https://mbostock.github.io/d3/talk/20111018/tree.html
//		$scope.call = function() {
//		      var m = [20, 120, 20, 120],
//		        w = 1280 - m[1] - m[3],
//		        h = 800 - m[0] - m[2],
...
//		        d3.select($scope.domNode).attr('class', 'node');
//		        // now restore the mouseover event or we won't be able to drag a 2nd time
//		        d3.select($scope.domNode).select('.ghostCircle').attr('pointer-events', '');
//		        updateTempConnector();
